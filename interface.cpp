...
void Interface::on_btnAddP_clicked()
{
    ui->stackedWidget->setCurrentIndex(2);
}

void Interface::on_btnPersonnel_clicked()
{
    this->setbtnEnable(ui->btnHome,btncurrent,"Home");
    ui->stackedWidget->setCurrentIndex(0);
}

void Interface::on_btnListP_clicked()
{
...
void Interface::on_btnTrie_clicked()
{
    //ui->tabpersonnel->setModel(tmppersonnel.trie());
}

void Interface::on_btnTriee_clicked()
{
    //ui->tabpersonnel->setModel(tmppersonnel.trie());
}
...
void Interface::on_btnreload_clicked()
{
    ui->tabpersonnel->setModel(tmppersonnel.afficher());
}
...
void Interface::on_btnService_clicked()
{
    ui->stackedWidget->setCurrentIndex(5);
}

void Interface::on_btnAddP_2_clicked()
{
    ui->stackedWidget->setCurrentIndex(6);
}

void Interface::on_btnListP_2_clicked()
{
    ui->stackedWidget->setCurrentIndex(7);
}

void Interface::on_btnreload_2_clicked()
{
    ui->tabservice->setModel(tmpservice.afficher());
}

void Interface::on_btnTriee_2_clicked()
{
...
void Interface::on_btnstat_clicked()
{
...
{
    ui->listWidgetChat->addItem("Me : "+ui->lineEditChat->text());
}
